...
/** @internal */
export function parseYmResponse<T>(
  schema: Schema<T>,
  input: unknown,
  operationId: string,
): T {
...
/** @internal */
export function parseYmBinaryResponse(
  input: unknown,
  operationId: string,
): ArrayBuffer {
  if (input instanceof ArrayBuffer) return input;
  throw new ResponseValidationError(
    `Yandex Market API response validation failed for operation ${operationId}.`,
    {
      operationId,
      issues: [
        {
...
/** @internal */
export function unexpectedYmSuccessStatus(
  operationId: string,
  status: number,
): never {
  throw new ResponseValidationError(
    `Yandex Market API returned an undocumented success status for operation ${operationId}.`,
    {
      operationId,
      issues: [
        {
...
function parseYmResult<T>(result: ParseResult<T>, operationId: string): T {
