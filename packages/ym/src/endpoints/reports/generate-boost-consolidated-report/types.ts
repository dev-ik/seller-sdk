...
type ReportsGenerateBoostConsolidatedRequest = {
...
/**
 * Параметры метода «Отчет по бусту продаж».
 *
 ...
 */
export type GenerateBoostConsolidatedReportInput = {
  /**
   ...
   * Тело запроса.
   */;
  readonly body: ReportsGenerateBoostConsolidatedRequest;
};
/**
 * Успешный ответ метода «Отчет по бусту продаж».
 *
 * 200: В ответ приходит идентификатор, который позволяет узнавать статус генерации и скачать готовый отчет.
 */
export type GenerateBoostConsolidatedReportResponse =
