...
/**
 * Параметры метода «Список товаров, находящихся в карантине по цене в кабинете».
 *
 ...
 */
export type GetBusinessQuarantineOffersInput = {
  /**
   * Параметры пути.
   */
  readonly path: {
...
/**
 * Успешный ответ метода «Список товаров, находящихся в карантине по цене в кабинете».
 *
 * 200: Список товаров в карантине.
 */
export type GetBusinessQuarantineOffersResponse =
