 ...
 */
export type GetContentV2DirectoryColorsInput = {
  /**
...
/**
 * Успешный ответ метода «Цвет».
 *
 * 200: Успешно.
 */
export type GetContentV2DirectoryColorsResponse = {
  /** Описание отсутствует в OpenAPI WB. */
  readonly data?: readonly {
    /**
     * Наименование цвета
     *
     * Пример: `"персиковый мелок"`.
     */
