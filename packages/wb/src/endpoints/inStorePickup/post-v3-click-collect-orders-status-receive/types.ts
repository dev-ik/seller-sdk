...
/**
 * Параметры метода «Сообщить, что заказы приняты покупателями».
 *
 ...
 */
export type PostV3ClickCollectOrdersStatusReceiveInput = {
  /**
   * Тело запроса.
   */
  readonly body?: {
...
/**
 * Успешный ответ метода «Сообщить, что заказы приняты покупателями».
 *
 * 200: Успешно.
 */
export type PostV3ClickCollectOrdersStatusReceiveResponse = {
  /**
