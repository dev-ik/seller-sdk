...
/**
 * Параметры метода «Получить документ».
 *
 ...
 */
export type GetV1DocumentsDownloadInput = {
  /**
...
/**
 * Успешный ответ метода «Получить документ».
 *
 * 200: Успешно.
 */
export type GetV1DocumentsDownloadResponse = {
  /** Описание отсутствует в OpenAPI WB. */
  readonly data?: {
    /**
     * Название документа
     *
     * Пример: `"Notice of redemption 44841941.zip"`.
     */
