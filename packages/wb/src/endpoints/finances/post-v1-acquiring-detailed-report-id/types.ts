...
/**
 * Параметры метода «Детализации к отчётам об издержках на приём платежей по ID отчётов».
 *
 ...
 */
export type PostV1AcquiringDetailedReportIdInput = {
  /**
   * Параметры пути.
   */
  readonly path: {
...
/**
 * Успешный ответ метода «Детализации к отчётам об издержках на приём платежей по ID отчётов».
 *
 * 200: Успешно.
 *
 * 204: Нет данных.
 */
export type PostV1AcquiringDetailedReportIdResponse =
  | readonly {
      /**
       * ID строки
       *
