...
/**
 * Параметры метода «Пагинация по товарам в группе».
 *
 ...
 */
export type PostV2SearchReportTableDetailsInput = {
  /**
   * Тело запроса.
   */
  readonly body: {
...
/**
 * Успешный ответ метода «Пагинация по товарам в группе».
 *
 * 200: Успешно.
 */
export type PostV2SearchReportTableDetailsResponse = {
  /** Описание отсутствует в OpenAPI WB. */
  readonly data: {
    /**
