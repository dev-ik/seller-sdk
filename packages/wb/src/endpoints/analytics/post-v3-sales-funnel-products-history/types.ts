...
/**
 * Параметры метода «Статистика карточек товаров по дням».
 *
 ...
 */
export type PostV3SalesFunnelProductsHistoryInput = {
  /**
   * Тело запроса.
   */
  readonly body: {
...
/**
 * Успешный ответ метода «Статистика карточек товаров по дням».
 *
 * 200: Успешно.
 */
export type PostV3SalesFunnelProductsHistoryResponse = readonly {
  /** Описание отсутствует в OpenAPI WB. */
  readonly product: {
    /**
     * Артикул WB
