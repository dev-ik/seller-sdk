...
/**
 * Параметры метода «Данные по группам».
 *
 ...
 */
export type PostV2StocksReportProductsGroupsInput = {
  /**
   * Тело запроса.
   */
  readonly body: {
...
/**
 * Успешный ответ метода «Данные по группам».
 *
 * 200: Успешно.
 */
export type PostV2StocksReportProductsGroupsResponse = {
  /** Описание отсутствует в OpenAPI WB. */
  readonly data: {
    /** Описание отсутствует в OpenAPI WB. */
